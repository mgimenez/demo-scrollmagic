...
gulp.task('copyImg', function() {
  gulp.src(path.src + '/img/**/*.{png,gif,jpg}')
    .pipe(copy())
...
gulp.task('watch', function () {
    ...
    gulp.watch(path.src + '/lib/**/*.{js,css}', ['copyLib']);
    gulp.watch(path.src + '/img/**/*.{png,gif,jpg}', ['copyImg']);
});
...
gulp.task('dist', function() {
  runSequence('clean', 'sass', 'hintJs', 'copyJs', 'copyHtml', 'copyImg', function() {
    console.log(color('SUCCESSFULLY DIST!', 'YELLOW'));
  });
});

gulp.task('dev', function(callback) {
  runSequence('clean', 'sass', 'hintJs', 'copyJs', 'copyLib', 'copyHtml', 'copyImg', 'watch', 'connect', function() {
    console.log(color('HAPPY DEV!', 'BLUE'));
  });
});

gulp.task('build', function(callback) {
  runSequence('clean', 'sass', 'hintJs', 'concatJs', 'uglifyJs', 'mergeScript', 'copyImg', function() {
